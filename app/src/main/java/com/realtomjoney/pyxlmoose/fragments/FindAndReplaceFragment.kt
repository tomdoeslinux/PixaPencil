...
class FindAndReplaceFragment(private val canvasColors: List<Int>) : Fragment(), ColourPickerListener {
    ...
    private fun setUpCanvasColorsRecyclerView() {
        ...
        binding.fragmentFindAndReplaceCanvasColorsRecyclerView.adapter = ColourPickerAdapter(canvasColors, this)
    }
    ...
    private fun setUpAvailableColorsRecyclerView() {
        ...
        binding.fragmentFindAndReplaceAvailableColorsRecyclerView.adapter = ColourPickerAdapter(ColourDatabase.toList(), this)
    }
